...
export const saveWiFiAccessPointConfig = async payload => await payloadJson('/api/config/wifi/accessPoint', 'POST', payload)
export const saveWiFiStationConfig = async payload => await payloadJson('/api/config/wifi/station', 'POST', payload)
export const removeWiFiStationConfig = async payload => await payloadJson('/api/config/wifi/station', 'DELETE', payload)
